...
export class BlogpostService {
  ...
  public getAllBlogs(): any {
   ...
   public getRecentBlogs(): any {
    let myResponse = this._http.get(this.baseUrl + '/recent/blogs').pipe(
      catchError(this.handleError)
    );
    console.log(myResponse);
    return myResponse;
   ...
   public getSingleBlogInformation(currentBlogId): Observable<any> {
  ...
  public getCategories(): any {
    let myResponse = this._http.get(this.baseUrl + '/category').pipe(
      catchError(this.handleError)
    );
    console.log(myResponse);
    return myResponse;
